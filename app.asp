    ...
    <div id="base">
        ...
        <div id="parri" style="display:none;">
            ...
            <div class="flex br-above">
                <a id="issue" class="flex dvayam-right no_under web_only1" rel="noopener" href="https://github.com/shubhattin/lipilekhikA_jAla/issues" target="_blank">
                    <span chv="git"></span>
                    <span lkh="issue"></span>
                </a>
    ...
    <div id="menu_body" style="left:-900px">
        ...
        <div id="info_links" class="web_only1 vr-flex">
            ...
            <a rel="noopener" target="_blank" class="menu_items menu_borders vr-flex no_under" tlt="git"
                href="https://github.com/shubhattin/lipilekhikA_jAla">
                <span chv="git"></span>
