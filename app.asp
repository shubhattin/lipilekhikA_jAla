<div id="main_section" style="display:none;">
    <span id="main1">
        <div class="in-flex">
            ...
            <span tlt='usage_btnm' class='usage_btnm imgs titles' id='up_usage'></span>
        </div>
        <div id="bdy">
            <div id="about">
            ...
            <div id="main">
                <div class="flex">
                    <span id="sa_mode" class="dvayam-right in-flex">
                        ...
                        <span class="titles in-flex" tlt="sa_1">
                            ...
                            <label for="sa_14" id="sa_1" class="black-yellow"></label>
                        </span>
                    </span>
                ...
                <div id="dynamic"></div>
                <button id="table_btn" class="in-flex">
            ...
            <div id="inter">
                ...
                <div class="in-flex">
                    ...
                    <button id="cp3" class="cpy_btn ekam"></button>
                    <span id="up_arrow_img" class="imgs"></span>
                ...
                <div id='warning1'>
                    <span id='warning' lipi='warning' tlt='warning' class='lipi titles'></span>
                    <span tlt='hide_warning' id='hide_warning' class='titles ekam-left'>❌</span>
                </div>
            </div>
        </div>
    </span>
